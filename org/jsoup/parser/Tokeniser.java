...
class Tokeniser
{
  ...
  String unescapeEntities(boolean paramBoolean)
  {
    ...
    while (!this.reader.isEmpty())
    {
      ...
      {
        this.reader.consume();
        Character localCharacter = consumeCharacterReference(null, paramBoolean);
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\org\jsoup\parser\Tokeniser.class
