...
{
  v(b paramb, Context paramContext, SocializeListeners.SocializeClientListener paramSocializeClientListener) {}
  
  public void onComplete(Bundle paramBundle, SHARE_MEDIA paramSHARE_MEDIA)
  {
    if (!TextUtils.isEmpty(paramBundle.getString("uid")))
    {
      b.a(this.a, this.b, paramSHARE_MEDIA, this.c);
      return;
    }
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\com\umeng\socialize\controller\a\v.class
