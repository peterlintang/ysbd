  ...
  implements SocializeListeners.OnCustomPlatformClickListener
{
  ...
  public void onClick(CustomPlatform paramCustomPlatform, String paramString, UMediaObject paramUMediaObject)
  {
    ...
    paramCustomPlatform = a.a(this.a, APP_PLATFORM.GOOGLE, paramCustomPlatform);
    if (paramCustomPlatform != null)
    {
      this.a.startActivity(paramCustomPlatform);
      m.a(this.a, this.b, paramString, paramUMediaObject, "googleplus");
      return;
    }
    Toast.makeText(this.a, "啊哦，找不到Google+客户端。", 0).show();
  }
}


/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\com\umeng\socialize\controller\b.class
