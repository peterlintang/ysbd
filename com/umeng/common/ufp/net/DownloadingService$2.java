  ...
  implements DownloadingService.a
{
  ...
  public void a(int paramInt, Exception paramException)
  {
    if (DownloadingService.c().containsKey(Integer.valueOf(paramInt)))
    {
      ...
      localObject = ((DownloadingService.d)localObject).b;
      ((Notification)localObject).contentView.setTextViewText(a.d(DownloadingService.a(this.a)), paramException.b + " 下载失败。");
      DownloadingService.b(this.a).notify(paramInt, (Notification)localObject);
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (DownloadingService.c().containsKey(Integer.valueOf(paramInt)))
    {
      localObject = (DownloadingService.d)DownloadingService.c().get(Integer.valueOf(paramInt));
      if (localObject != null)
      {
        ...
        b.a(DownloadingService.a(this.a)).a(locala.a, locala.c, 100);
