  ...
  extends ArrayAdapter<Promoter>
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((paramView == null) || (paramView.getTag() == null))
    {
      ...
      paramViewGroup.a = ((ImageView)((View)localObject1).findViewById(c.D(this.c)));
      paramViewGroup.b = ((TextView)((View)localObject1).findViewById(c.g(this.c)));
      paramViewGroup.c = ((TextView)((View)localObject1).findViewById(c.B(this.c)));
      paramViewGroup.d = ((TextView)((View)localObject1).findViewById(c.C(this.c)));
      paramViewGroup.e = ((TextView)((View)localObject1).findViewById(c.p(this.c)));
      paramViewGroup.f = ((Button)((View)localObject1).findViewById(c.H(this.c)));
    }
    for (;;)
    {
      try
      {
        paramViewGroup.g = ((ImageView)((View)localObject1).findViewById(c.n(this.c)));
        Object localObject2;
        if (Log.LOG)
        {
        ...
        else
        {
          ...
          paramViewGroup.a.setImageDrawable(this.c.getResources().getDrawable(com.umeng.newxp.a.b.b(this.c)));
          if (paramViewGroup.a != null)
          {
            if (!ExchangeConstants.ROUND_ICON) {
              break label676;
            }
            com.umeng.common.ufp.net.g.a(this.c, paramViewGroup.a, ((Promoter)localObject1).icon, false, null, null, true);
          }
          if (paramViewGroup.b != null)
          {
            if (!com.umeng.common.ufp.b.a(((Promoter)localObject1).app_package_name, this.c)) {
              break label696;
            }
            paramViewGroup.b.setText(e.b(this.c));
            if ((!com.umeng.common.ufp.b.a(((Promoter)localObject1).app_package_name, this.c)) && (!TextUtils.isEmpty(((Promoter)localObject1).price))) {
          ...
          if (paramViewGroup.e != null) {
            paramViewGroup.e.setText(com.umeng.common.ufp.util.g.a(this.c, ((Promoter)localObject1).size));
          }
          if (paramViewGroup.f != null) {
            paramViewGroup.d.setText(((Promoter)localObject1).ad_words);
          }
          localObject2 = new a.1(this, (Promoter)localObject1, paramInt);
          if (paramViewGroup.f != null)
          {
            if (!com.umeng.common.ufp.b.a(((Promoter)localObject1).app_package_name, this.c)) {
              break label776;
          ...
          b(this.e);
          paramView.setOnClickListener(new a.2(this, (Promoter)localObject1, paramInt));
      ...
      continue;
      label676:
      com.umeng.common.ufp.net.g.a(this.c, paramViewGroup.a, ((Promoter)localObject1).icon, false);
      continue;
      label696:
