  ...
  extends RelativeLayout
{
  ...
  private final GridPage.GridPageAdapter b;
  private final GridTemplateConfig c;
  private final Context d;
  private int e = 0;
  private final List<LinearLayout> f;
  
  public GridPage(Context paramContext, GridPage.GridPageAdapter paramGridPageAdapter, GridTemplateConfig paramGridTemplateConfig)
  {
    super(paramContext);
    this.d = paramContext;
    new i(this.d);
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\com\umeng\newxp\view\widget\GridPage.class
