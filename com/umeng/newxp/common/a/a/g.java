  ...
  implements a, b
{
  ...
  protected g(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.n = paramInt1;
    this.o = paramInt2;
  ...
  public int a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    a(paramArrayOfByte2, 0, paramArrayOfByte2.length);
    a(paramArrayOfByte2, 0, -1);
    int i1 = this.i;
    if (i1 <= paramArrayOfByte1.length)
    {
      c(paramArrayOfByte1, 0, i1);
      return i1;
    }
    return -1;
  }
  ...
  public int b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt)
  {
    e();
    if ((paramArrayOfByte2 == null) || (paramInt == 0)) {
      return -1;
    }
    b(paramArrayOfByte2, 0, paramInt);
    b(paramArrayOfByte2, 0, -1);
    paramInt = this.i - this.q;
    if (paramInt <= paramArrayOfByte1.length)
    {
      c(paramArrayOfByte1, 0, paramInt);
      return paramInt;
    }
    return -1;
  }
  ...
  {
    if (!(paramObject instanceof byte[])) {
      throw new com.umeng.newxp.common.a.g("Parameter supplied to Base-N encode is not a byte[]");
    }
  ...
  public boolean b(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    {
      if ((!a(paramArrayOfByte[i1])) && ((!paramBoolean) || ((paramArrayOfByte[i1] != 61) && (!c(paramArrayOfByte[i1]))))) {
        return false;
      }
      i1 += 1;
    }
  ...
  {
    return b(l.f(paramString), true);
  }
  
  public String l(byte[] paramArrayOfByte)
  {
    return l.f(b(paramArrayOfByte));
  }
