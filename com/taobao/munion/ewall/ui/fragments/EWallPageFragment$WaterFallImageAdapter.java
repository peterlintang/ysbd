...
public class EWallPageFragment$WaterFallImageAdapter
  extends EWallPageFragment.ImageAdapter
{
  private LinearLayout.LayoutParams mImageViewLayoutParams;
  
  public EWallPageFragment$WaterFallImageAdapter(List<a> paramList, c paramc, int paramInt)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = new EWallPageFragment.WaterFlowItemHolder(this.this$0);
      paramView.inflate(this.this$0.getActivity());
      localView = paramView.contentView;
      paramView.imageView.setLayoutParams(this.mImageViewLayoutParams);
      paramViewGroup = paramView;
    }
    for (;;)
    {
      if (paramViewGroup.imageView.getLayoutParams().height != this.mItemHeight) {
        paramViewGroup.imageView.setLayoutParams(this.mImageViewLayoutParams);
      }
      ...
      return localView;
      paramViewGroup = (EWallPageFragment.WaterFlowItemHolder)paramView.getTag();
      localView = paramView;
    }
  }
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\com\taobao\munion\ewall\ui\fragments\EWallPageFragment$WaterFallImageAdapter.class
