  ...
  implements q
{
  ...
  public boolean checkArgs()
  {
    ...
    {
      c.a("MicroMsg.SDK.WXImageObject", "checkArgs fail, all arguments are null");
      return false;
    }
    if ((this.imageData != null) && (this.imageData.length > 10485760))
    {
      c.a("MicroMsg.SDK.WXImageObject", "checkArgs fail, content is too large");
      return false;
    }
    if ((this.imagePath != null) && (this.imagePath.length() > 10240))
    {
      c.a("MicroMsg.SDK.WXImageObject", "checkArgs fail, path is invalid");
      return false;
    }
    if (this.imagePath != null)
    {
      ...
      while (i > 10485760)
      {
        c.a("MicroMsg.SDK.WXImageObject", "checkArgs fail, image content is too large");
        return false;
    ...
    {
      c.a("MicroMsg.SDK.WXImageObject", "checkArgs fail, url is invalid");
      return false;
    }
    return true;
  }
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\mm\sdk\openapi\WXImageObject.class
