  ...
  implements q
{
  ...
  public boolean checkArgs()
  {
    ...
    {
      c.a("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, all arguments is null");
      return false;
    }
    if ((this.extInfo != null) && (this.extInfo.length() > 2048))
    {
      c.a("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, extInfo is invalid");
      return false;
    }
    if ((this.filePath != null) && (this.filePath.length() > 10240))
    {
      c.a("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, filePath is invalid");
      return false;
    }
    if (this.filePath != null)
    {
      ...
      while (i > 10485760)
      {
        c.a("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, fileSize is too large");
        return false;
    ...
    {
      c.a("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, fileData is too large");
      return false;
    }
    return true;
  }
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\mm\sdk\openapi\WXAppExtendObject.class
