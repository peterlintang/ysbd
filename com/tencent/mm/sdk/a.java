  ...
  implements SharedPreferences
{
  ...
  private Object a(String paramString)
  {
    for (;;)
    {
      try
      {
        Cursor localCursor = this.a.query(e.a, this.b, "key = ?", new String[] { paramString }, null);
        if (localCursor == null) {
          return null;
        }
        ...
        {
          paramString = d.a(localCursor.getInt(i), localCursor.getString(j));
          localCursor.close();
          return paramString;
        }
      }
  ...
  public final Map<String, ?> getAll()
  {
    try
    {
      Cursor localCursor = this.a.query(e.a, this.b, null, null, null);
      if (localCursor == null) {
        return null;
      }
      ...
      {
        Object localObject = d.a(localCursor.getInt(j), localCursor.getString(k));
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\mm\sdk\a.class
