...
{
  l(UMShareActivity paramUMShareActivity) {}
  ...
  public final void onClick(CustomPlatform paramCustomPlatform, String paramString, UMediaObject paramUMediaObject)
  {
    ...
    this.a.a.c();
    paramString = this.a;
    boolean bool = UMShareActivity.a(this.a.a, paramCustomPlatform, paramUMediaObject, true);
    if (bool)
    {
      ...
      paramString.postShareByCustomPlatform(this.a, null, "wxtimeline", localUMShareMsg, null);
    }
    paramUMediaObject = this.a;
    paramString = paramCustomPlatform;
    if ("#" + bool + "[Circle]  " + paramCustomPlatform == null) {
      paramString = "";
    }
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\com\ireadercity\b2\share\l.class
