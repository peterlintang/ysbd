...
public class b
{
  ...
  private static byte[] b(String paramString)
  {
    ...
    //   19: aload_0
    //   20: ldc -32
    //   22: invokevirtual 240	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   25: astore_2
    //   26: aload_2
    //   27: astore_0
    //   28: aload_0
    //   29: aload_0
    //   30: arraylength
    //   31: invokestatic 243	com/ireadercity/b2/b/b:b	([BI)[B
    //   34: astore 6
    //   36: aload 6
    //   38: ifnull +118 -> 156
    //   41: aload 6
    ...
    //   77: astore 7
    //   79: new 247	java/io/ByteArrayOutputStream
    //   82: dup
    //   83: invokespecial 248	java/io/ByteArrayOutputStream:<init>	()V
    //   86: astore 4
    //   88: new 250	java/io/ByteArrayInputStream
    //   91: dup
    //   92: aload 6
    //   94: invokespecial 251	java/io/ByteArrayInputStream:<init>	([B)V
    //   97: astore_2
    //   98: new 253	java/util/zip/GZIPInputStream
    //   101: dup
    //   102: aload_2
    //   103: invokespecial 256	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   106: astore_0
    //   107: aload_0
    //   108: aload 7
    //   110: invokevirtual 260	java/util/zip/GZIPInputStream:read	([B)I
    //   113: istore_1
    //   114: iload_1
    //   115: iflt +53 -> 168
    //   118: aload 4
    ...
    //   122: iconst_0
    //   123: iload_1
    //   124: invokevirtual 264	java/io/ByteArrayOutputStream:write	([BII)V
    //   127: goto -20 -> 107
    //   130: astore 5
    //   132: aload_0
    //   133: astore_3
    ...
    //   138: astore_2
    //   139: aload_2
    //   140: invokevirtual 267	java/io/IOException:printStackTrace	()V
    //   143: aload 4
    //   145: invokevirtual 270	java/io/ByteArrayOutputStream:close	()V
    //   148: aload_3
    //   149: invokevirtual 271	java/util/zip/GZIPInputStream:close	()V
    //   152: aload_0
    //   153: invokevirtual 272	java/io/ByteArrayInputStream:close	()V
    //   156: aload 6
    //   158: areturn
    //   159: astore_2
    //   160: aload_0
    //   161: invokevirtual 275	java/lang/String:getBytes	()[B
    //   164: astore_0
    //   165: goto -137 -> 28
    //   168: aload 4
    //   170: invokevirtual 278	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   173: astore_3
    //   174: aload 4
    //   176: invokevirtual 270	java/io/ByteArrayOutputStream:close	()V
    //   179: aload_0
    //   180: invokevirtual 271	java/util/zip/GZIPInputStream:close	()V
    //   183: aload_2
    //   184: invokevirtual 272	java/io/ByteArrayInputStream:close	()V
    //   187: aload_3
    //   188: areturn
    //   189: astore_0
    //   190: aload_3
    ...
    //   200: astore_3
    //   201: aload 4
    //   203: invokevirtual 270	java/io/ByteArrayOutputStream:close	()V
    //   206: aload_3
    //   207: invokevirtual 271	java/util/zip/GZIPInputStream:close	()V
    //   210: aload_2
    //   211: invokevirtual 272	java/io/ByteArrayInputStream:close	()V
    //   214: aload_0
    //   215: athrow
    //   216: astore 4
    //   218: goto -39 -> 179
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\com\ireadercity\b2\b\b.class
