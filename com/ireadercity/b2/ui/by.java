...
{
  by(BookReadingActivityNew paramBookReadingActivityNew) {}
  ...
  public final void onProgressChanged(SeekBar paramSeekBar, int paramInt, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      if (((Integer)localObject).intValue() < 5) {
        paramSeekBar = Integer.valueOf(5);
      }
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\com\ireadercity\b2\ui\by.class
