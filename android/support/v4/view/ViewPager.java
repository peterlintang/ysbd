  ...
  extends ViewGroup
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((this.mPageMargin > 0) && (this.mMarginDrawable != null) && (this.mItems.size() > 0) && (this.mAdapter != null))
    {
      ...
      Object localObject = (ViewPager.ItemInfo)this.mItems.get(0);
      float f1 = ((ViewPager.ItemInfo)localObject).offset;
        ...
        for (Object localObject3 = addNewItem(this.mCurItem, paramInt);; localObject3 = localObject1)
        {
          ...
          if (localObject3 != null)
          {
            ...
            if (n >= 0)
            {
              ...
              f1 = f3;
              i = k;
              if (m == ((ViewPager.ItemInfo)localObject4).position)
              {
                localObject1 = localObject4;
                paramInt = n;
                f1 = f3;
                i = k;
                if (!((ViewPager.ItemInfo)localObject4).scrolling)
                {
                  this.mItems.remove(n);
                  this.mAdapter.destroyItem(this, m, ((ViewPager.ItemInfo)localObject4).object);
                  paramInt = n - 1;
                  i = k - 1;
                  if (paramInt < 0) {
                    break label559;
            ...
            for (;;)
            {
              ...
              break label341;
              label538:
              f2 = 2.0F - ((ViewPager.ItemInfo)localObject3).widthFactor + getPaddingLeft() / i4;
              break label354;
              label559:
              localObject1 = null;
              f1 = f3;
              continue;
              label568:
              if ((localObject4 != null) && (m == ((ViewPager.ItemInfo)localObject4).position))
              {
                f1 = f3 + ((ViewPager.ItemInfo)localObject4).widthFactor;
                paramInt = n - 1;
                if (paramInt >= 0)
                {
                  localObject1 = (ViewPager.ItemInfo)this.mItems.get(paramInt);
          ...
          for (;;)
          {
            ...
            if (localObject3 != null) {}
            for (localObject1 = ((ViewPager.ItemInfo)localObject3).object;; localObject1 = null)
            {
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\view\ViewPager.class
