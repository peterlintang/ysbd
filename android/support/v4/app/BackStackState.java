  ...
  public final BackStackRecord instantiate(FragmentManagerImpl paramFragmentManagerImpl)
  {
    ...
    while (i < this.mOps.length)
    {
      ...
      if (FragmentManagerImpl.DEBUG) {
        new StringBuilder("Instantiate ").append(localBackStackRecord).append(" op #").append(k).append(" base fragment #").append(this.mOps[j]).toString();
      }
      ...
      for (localOp.fragment = ((Fragment)paramFragmentManagerImpl.mActive.get(j));; localOp.fragment = null)
      {
        ...
        for (;;)
        {
          ...
          if (FragmentManagerImpl.DEBUG) {
            new StringBuilder("Instantiate ").append(localBackStackRecord).append(" set remove fragment #").append(this.mOps[j]).toString();
          }
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\app\BackStackState.class
