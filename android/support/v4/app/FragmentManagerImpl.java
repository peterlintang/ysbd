  ...
  extends FragmentManager
{
  ...
  public final int allocBackStackIndex(BackStackRecord paramBackStackRecord)
  {
    try
    {
      ...
      if (DEBUG) {
        new StringBuilder("Adding back stack index ").append(i).append(" with ").append(paramBackStackRecord).toString();
      }
  ...
  final boolean popBackStackState(Handler paramHandler, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      if (DEBUG) {
        new StringBuilder("Popping back stack state: ").append(paramHandler.get(paramInt1)).toString();
      }
      ...
      if (paramParcelable.mActive != null)
      {
        ...
        if (i < paramParcelable.mActive.length)
        {
          ...
          if (localObject1 != null)
          {
            ...
            if (DEBUG) {
              new StringBuilder("restoreAllState: active #").append(i).append(": ").append(localObject2).toString();
            }
        ...
        if (paramArrayList != null)
        {
          ...
          if (i < paramArrayList.size())
          {
            ...
            for (((Fragment)localObject1).mTarget = ((Fragment)this.mActive.get(((Fragment)localObject1).mTargetIndex));; ((Fragment)localObject1).mTarget = null)
            {
              ...
              break;
              label427:
              new StringBuilder("Re-attaching retained fragment ").append(localObject1).append(" target no longer exists: ").append(((Fragment)localObject1).mTargetIndex).toString();
            }
          }
        }
        if (paramParcelable.mAdded != null)
        {
          ...
          while (i < paramParcelable.mAdded.length)
          {
            ...
            if (DEBUG) {
              new StringBuilder("restoreAllState: added #").append(i).append(": ").append(paramArrayList).toString();
            }
        ...
        while (i < paramParcelable.mBackStack.length)
        {
          ...
          if (DEBUG)
          {
            new StringBuilder("restoreAllState: back stack #").append(i).append(" (index ").append(paramArrayList.mIndex).append("): ").append(paramArrayList).toString();
  ...
  final Parcelable saveAllState()
  {
    ...
    if (j < k)
    {
      ...
      if ((((Fragment)localObject1).mState > 0) && (((FragmentState)localObject2).mSavedFragmentState == null))
      {
        ...
        label295:
        if (DEBUG) {
          new StringBuilder("Saved state of ").append(localObject1).append(": ").append(((FragmentState)localObject2).mSavedFragmentState).toString();
        }
        i = 1;
      }
    }
      ...
      if (this.mAdded != null)
      {
        ...
        if (j > 0)
        {
          ...
          for (;;)
          {
            ...
            if (DEBUG) {
              new StringBuilder("saveAllState: adding fragment #").append(i).append(": ").append(this.mAdded.get(i)).toString();
            }
            i += 1;
          }
        }
      ...
      if (this.mBackStack != null)
      {
        ...
        if (j > 0)
        {
          ...
          for (;;)
          {
            ...
            if (DEBUG) {
              new StringBuilder("saveAllState: adding back stack #").append(i).append(": ").append(this.mBackStack.get(i)).toString();
            }
            i += 1;
          }
        }
  ...
  public final void setBackStackIndex(int paramInt, BackStackRecord paramBackStackRecord)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 289	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   6: ifnonnull +14 -> 20
    //   9: aload_0
    //   10: new 228	java/util/ArrayList
    //   13: dup
    //   14: invokespecial 229	java/util/ArrayList:<init>	()V
    //   17: putfield 289	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   20: aload_0
    //   21: getfield 289	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   24: invokevirtual 287	java/util/ArrayList:size	()I
    //   27: istore 4
    //   29: iload 4
    //   31: istore_3
    //   32: iload_1
    ...
    //   41: ifeq +31 -> 72
    //   44: new 141	java/lang/StringBuilder
    //   47: dup
    //   48: ldc_w 291
    //   51: invokespecial 144	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   54: iload_1
    //   55: invokevirtual 294	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   58: ldc_w 296
    //   61: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   64: aload_2
    //   65: invokevirtual 245	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   68: invokevirtual 152	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   71: pop
    //   72: aload_0
    //   73: getfield 289	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   76: iload_1
    //   77: aload_2
    //   78: invokevirtual 313	java/util/ArrayList:set	(ILjava/lang/Object;)Ljava/lang/Object;
    //   81: pop
    //   82: aload_0
    //   83: monitorexit
    //   84: return
    ...
    //   87: if_icmpge +73 -> 160
    //   90: aload_0
    //   91: getfield 289	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   94: aconst_null
    //   95: invokevirtual 233	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   98: pop
    //   99: aload_0
    //   100: getfield 283	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   103: ifnonnull +14 -> 117
    //   106: aload_0
    //   107: new 228	java/util/ArrayList
    //   110: dup
    //   111: invokespecial 229	java/util/ArrayList:<init>	()V
    //   114: putfield 283	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   117: getstatic 85	android/support/v4/app/FragmentManagerImpl:DEBUG	Z
    //   120: ifeq +21 -> 141
    //   123: new 141	java/lang/StringBuilder
    //   126: dup
    //   127: ldc_w 1110
    //   130: invokespecial 144	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   133: iload_3
    //   134: invokevirtual 294	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   137: invokevirtual 152	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   140: pop
    //   141: aload_0
    //   142: getfield 283	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   145: iload_3
    //   146: invokestatic 575	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   149: invokevirtual 233	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   152: pop
    //   153: iload_3
    //   154: iconst_1
    //   155: iadd
    //   156: istore_3
    //   157: goto -72 -> 85
    //   160: getstatic 85	android/support/v4/app/FragmentManagerImpl:DEBUG	Z
    //   163: ifeq +31 -> 194
    //   166: new 141	java/lang/StringBuilder
    //   169: dup
    //   170: ldc_w 307
    //   173: invokespecial 144	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   176: iload_1
    //   177: invokevirtual 294	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   180: ldc_w 309
    //   183: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   186: aload_2
    //   187: invokevirtual 245	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   190: invokevirtual 152	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   193: pop
    //   194: aload_0
    //   195: getfield 289	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   198: aload_2
    //   199: invokevirtual 233	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   202: pop
    //   203: goto -121 -> 82
    //   206: astore_2
    //   207: aload_0
    ...
    //   0	211	0	this	FragmentManagerImpl
    //   0	211	1	paramInt	int
    //   0	211	2	paramBackStackRecord	BackStackRecord
    //   31	126	3	i	int
    //   27	9	4	j	int
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\app\FragmentManagerImpl.class
