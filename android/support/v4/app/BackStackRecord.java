      ...
      for (BackStackRecord.Op localOp = this.mHead; localOp != null; localOp = localOp.next)
      {
        ...
        if (localOp.removed != null)
        {
          ...
          while (i >= 0)
          {
            ...
            localFragment.mBackStackNesting += paramInt;
            if (FragmentManagerImpl.DEBUG) {
              new StringBuilder("Bump nesting of ").append(localFragment).append(" to ").append(localFragment.mBackStackNesting).toString();
            }
            i -= 1;
          }
        }
...
/* Location:              E:\project\angent\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\app\BackStackRecord.class
